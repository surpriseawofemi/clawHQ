...
| 35 | Super Boss Chat: per-agent session reserved for the human, opened by default and created by ClawHQ; plugin 0.2.1 redirects agent sends away from it and briefs agents in-session | v0.1.42 |
